...
function preload()
{
  ...
  destroyimg = loadImage("assests/Destroy.png");
}
...
if (Yamakazu.isTouching(shootgrp)){
    shootgrp.destroyEach();
    lifecount = lifecount-1;
}
if (lifecount === 0){
  Yamakazu.addImage("destroyimg",destroyimg)
  Yamakazu.changeImage("destroyimg")
  Yamakazu.scale = 0.3;
}
